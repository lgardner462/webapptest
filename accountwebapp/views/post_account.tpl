...
<html>
  <body>
	...
	Account requests may take 2 school days to process.
      ...
      <form action="/id_rsa" method="post" enctype="multipart/form-data"> 
	<input type = hidden name = "keyPath" value = "{{keyZipPath}}"/>
	<input type = "submit" name = "submitDownloadKey" value = "Download Private Keys" onclick="this.disabled=true;this.value='Downloading...';this.form.submit();"/>
      </form>	
      % end
